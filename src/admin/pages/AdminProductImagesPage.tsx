  ...
  return (
    <div>
      ...
      <p className="mt-6 max-w-2xl text-[0.7rem] leading-6 text-mocha">
        {connected
          ? 'تصویر اصلی همان تصویری است که در کارت محصول، صفحهٔ جزئیات، سبد خرید و تسویه‌حساب نمایش داده می‌شود؛ انتخاب آن مستقیماً در دیتابیس ثبت می‌شود.'
        ...
        <div className="adm-upload-options">
          <div className="adm-upload-option">
            <div>
              ...
              <small>همین تصویر در کارت محصول، صفحهٔ جزئیات، سبد خرید و تسویه‌حساب نمایش داده می‌شود.</small>
            </div>
            <Toggle
              checked={makePrimary}
              onChange={(value) => {
