...
export default function QrCodeSection() {
  ...
  return (
    <section
      className="cv-auto burgundy-ambient relative bg-wine-900 px-4 py-12 text-cream-50 sm:px-6 sm:py-14"
    ...
    >
      ...
      <div className="mx-auto grid max-w-4xl items-center gap-9 sm:gap-10 lg:grid-cols-[minmax(0,14.5rem)_minmax(0,1fr)] lg:gap-14">
        {/* QR frame — the replaceable artwork slot */}
        <div className="w-full max-w-[14.5rem] justify-self-center lg:justify-self-start">
          <div className="rounded-2xl bg-cream-50 p-3.5 shadow-[0_30px_60px_-38px_rgba(0,0,0,0.8)] ring-1 ring-cream-50/25">
            <div className="relative aspect-square w-full overflow-hidden rounded-xl bg-white">
              {qrMissing ? (
                <div className="flex h-full w-full flex-col items-center justify-center gap-2.5 rounded-xl border border-dashed border-espresso/20 bg-cream-50 px-3 text-center">
          ...
          <p className="mt-3 text-center font-display text-[0.6rem] uppercase tracking-[0.32em] text-cream-200/55 lg:text-start">
            Scan · Zheno
          </p>
        </div>
        ...
        <div className="text-center lg:text-start">
          <p className="kicker kicker-dark font-display">Scan &amp; Share</p>
          <h2 className="mt-3 text-[1.35rem] font-light leading-[1.6] text-cream-50 sm:text-[1.7rem]">
            یک اسکن، تمام طعم‌ها
          </h2>
          <p className="mx-auto mt-3 max-w-md text-[0.78rem] font-light leading-7 text-cream-200/75 lg:mx-0">
            دوربین گوشی را روی کد بگیرید تا منوی ژینو، طعم‌ها و دستورهای آماده‌سازی همیشه همراهتان باشد.
          </p>

          <div className="mt-6 flex flex-col items-center gap-3 sm:flex-row sm:justify-center lg:justify-start">
            <button type="button" onClick={share} className="btn-lux btn-line-light px-6 py-2.5 text-[0.8rem]">
            ...
            {shareState !== 'idle' && (
              <p aria-live="polite" className="text-[0.7rem] leading-6 text-cream-200/70">
