      ...
      >
        ...
        <div className="relative z-20 mx-auto w-full max-w-6xl px-4 pb-[calc(var(--hero-curve)_+_1.75rem)] pt-[5.5rem] sm:px-6 lg:grid lg:grid-cols-[1.04fr_0.96fr] lg:items-center lg:gap-12 lg:pb-[calc(var(--hero-curve)_+_2.5rem)] lg:pt-28">
          ...
          <div className="text-center lg:text-right">
            ...
            {/* Hero headline — Vazirmatn Black (900): the storefront's
                display voice. Two fixed lines, RTL, bold + premium. */}
            <h1
              className="rise mt-4 font-headline text-[1.8rem] font-black leading-[1.42] text-balance sm:text-4xl sm:leading-[1.36] lg:mt-5 lg:text-[3.2rem] lg:leading-[1.3]"
            ...
            {/* Hero subtitle — deliberately smaller + simpler than the headline */}
            <p
              className="rise mt-3 text-[0.92rem] font-normal leading-7 text-cream-100/80 sm:mt-4 sm:text-[1.02rem]"
        ...
        <div className="mx-auto max-w-6xl px-4 pb-14 pt-12 sm:px-6 sm:pb-16 sm:pt-16">
          ...
          {groups.map((group, gi) => (
            <div key={group.key} className={gi === 0 ? 'mt-8' : 'mt-10'}>
              ...
              <div
                ref={group.reveal}
                className="reveal-stagger mt-4 grid grid-cols-2 gap-3.5 sm:gap-5 md:grid-cols-3 lg:grid-cols-4"
              >
